/*
 * src/display/font_5x7.c — Public 5x7 ASCII font.
 *
 * Compact subset (0x20..0x7E). 5 bytes per glyph, msb-first row order.
 * Bitmap columns are vertical 7-bit stripes.
 */
#include "display/font.h"

const uint8_t font_5x7[FONT_NUM_GLYPHS][FONT_GLYPH_BYTES] = {
